...
import { Container, PageHeader, Section, Footer } from "@/components/ui/layout";
...
const productos = [
  ...
  { id: 5, nombre: "Vestido de Tencel", precio: 45000, marca: "Veralume" },
  { id: 6, nombre: "Camisa de cáñamo", precio: 35000, marca: "Linao" },
  { id: 7, nombre: "Pantaloneta de bambú", precio: 28000, marca: "Ékoa" },
  { id: 8, nombre: "Sudadera de algodón", precio: 50000, marca: "Auralé" },
  { id: 9, nombre: "Shorts de ramio", precio: 30000, marca: "Veralume" },
  { id: 10, nombre: "Pijama de modal ecológico", precio: 33000, marca: "Linao" },
  { id: 11, nombre: "Leggings de Seacell", precio: 42000, marca: "Ékoa" },
  { id: 12, nombre: "Falda de cupro", precio: 36000, marca: "Auralé" },
  { id: 13, nombre: "Chaqueta de lana orgánica", precio: 65000, marca: "Veralume" },
  { id: 14, nombre: "Camiza tipo esqueleto de bambú", precio: 18000, marca: "Linao" },
  { id: 15, nombre: "Blusa de soya", precio: 32000, marca: "Ékoa" },
  { id: 16, nombre: "Bufanda de lino", precio: 20000, marca: "Auralé" },
  { id: 17, nombre: "Zapatos de cuero vegetal", precio: 70000, marca: "Veralume" },
];

const ProductCard = ({ producto, currency, addToCart }) => (
...
const Marcas = () => (
  <div className="min-h-screen bg-gray-50">
    <PageHeader 
      ...
      description="Conoce las marcas sostenibles que están cambiando la industria de la moda"
    />
    <Section>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        {[
          ...
          <Card key={marca.nombre} className="bg-white hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-green-800 mb-4">{marca.nombre}</h3>
              <p className="text-gray-600 leading-relaxed">{marca.descripcion}</p>
            </CardContent>
          </Card>
        ))}
      </div>
